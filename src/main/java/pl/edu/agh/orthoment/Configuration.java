...
public class Configuration {
    ...
    public static final String DOCTOR_1_KEY = "doctor_1";
    public static final String TECHNICIAN_0_KEY = "technician_0";
    public static final String TECHNICIAN_1_KEY = "technician_1";
}
